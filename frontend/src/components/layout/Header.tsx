      ...
      <div className="max-w-6xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
        <div className="flex items-center gap-3.5">
          ...
          <div>
            ...
            <p className="text-xs text-[#a39b91]">Generate high-precision transcripts & subtitles from audio or video files.</p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-3">
          {loading && !health ? (
            ...
            <div className="flex items-center gap-2 px-3.5 py-1.5 rounded-xl bg-blue-950/40 border border-blue-500/30 text-xs font-medium text-blue-300 shadow-sm shadow-blue-950/40">
              <Zap className="w-3.5 h-3.5 text-[#3b82f6] animate-pulse" />
              <span>GPU Acceleration Active</span>
              <span className="w-2 h-2 rounded-full bg-[#3b82f6] animate-ping ml-1" />
            </div>
          ) : (
