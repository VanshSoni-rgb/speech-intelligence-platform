    ...
    <div className="glass-panel rounded-2xl p-6 sm:p-8 shadow-2xl border border-[#2b2823] transition-all duration-300">
      <div className="flex items-center justify-between mb-5">
        <div>
          ...
          <p className="text-xs text-[#a39b91]">Select an audio or video file for AI speech transcription</p>
        </div>
        ...
        {selectedFile ? (
          <div className="flex flex-col items-center animate-fade-in relative pt-1">
            ...
            >
              ...
              <span>Remove / Choose a different file</span>
            </button>
          </div>
        ) : (
          ...
          >
            {isUploading ? (
              <>
                ...
                <span>Uploading & Submitting Media...</span>
              </>
            ) : (
              <>
